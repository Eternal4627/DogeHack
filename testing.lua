...
local Window = OrionLib:MakeWindow({IntroText = "DogeHack",Name = "DogeHack 1.0", HidePremium = true, SaveConfig = true, ConfigFolder = "DoorsSex"})
if game.PlaceId == 10716783997 then
    OrionLib:MakeNotification({
        Name = "DogeAnticheat",
        Content = "HACK DETECTED BANNED....",
        Time = 2
    })
end
...
VisualsTab:AddToggle({
    ...
    Callback = function()
        pcall(function()
            ...
            local LastRefresh = 0;
            local OptionsFile = '3TERN4L_ESP_SETTINGS.dat';
            local Binding = false;
            local BindedKey = nil;
            local OIndex = 0;
            local LineBox = {};
            ...
            shared.RSName = shared.RSName or ('UnnamedESP_by_eternal#0069-' .. HttpService:GenerateGUID(false));
